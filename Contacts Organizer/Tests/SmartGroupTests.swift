...
final class SmartGroupTests: XCTestCase {
    ...
    func testOrganizationGrouping() {
        ...
        let results = ContactsManager.shared.generateSmartGroups(definitions: [definition])
    ...
    func testMultipleDefinitions() {
        ...
        let results = ContactsManager.shared.generateSmartGroups(definitions: definitions)
